  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (iconFile) {
        ...
        const uploadResponse = await axios.post("https://api.simotakhfid.ma:3000/api/upload", formData);
      ...
      await axios.post("https://api.simotakhfid.ma:3000/api/categorys", categoryPayload);
