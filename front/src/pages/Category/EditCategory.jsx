...
const EditCategory = () => {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        const response = await axios.get(`https://api.simotakhfid.ma:3000/api/categorys/${id}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(`https://api.simotakhfid.ma:3000/api/categorys/${id}`, categoryData);
