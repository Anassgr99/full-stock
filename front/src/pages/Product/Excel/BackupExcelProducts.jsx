...
const DownloadExcelButtonProducts = () => {
  ...
  const handleDownloadProducts = async () => {
    try {
      ...
      const response = await axios({
        url: "https://api.simotakhfid.ma/api/downloadProductsExcel",
        method: "GET",
    ...
    <div className="p-3">
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold mb-4">Exporter les données</h2>

            <div className="mb-6">
              <p className="mb-4">Cliquez sur le bouton ci-dessous pour télécharger tous les produits au format Excel.</p>
...
export default DownloadExcelButtonProducts;