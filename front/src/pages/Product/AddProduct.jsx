...
const AddProduct = () => {
    ...
    const fetchData = async () => {
      try {
        const [storesRes, categoriesRes] = await Promise.all([
          axios.get("https://api.simotakhfid.ma/api/stores"),
          axios.get("https://api.simotakhfid.ma/api/categorys"),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const productRes = await axios.post("https://api.simotakhfid.ma/api/products", productData);
      ...
      await axios.post("https://api.simotakhfid.ma/api/store-products/add", storeProductData);
